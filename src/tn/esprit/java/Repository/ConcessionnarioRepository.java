...
public class ConcessionnarioRepository implements IConcessionnarioRepository {
    ...
    public void insertConcessionario(Concessionario concessionario) {
        ...
        ConcessionarioMapperBo concessionarioMapperBo = new ConcessionarioMapperBo();
        this.concessionarioDao.insertConcessionario(concessionario.getNome(),concessionario.getCitta(),concessionario.getIndirizzo()); //void
        //this.autocarriDao.insertAutocarri(autocarri.getMarca(),autocarri.getModello(), (int) autocarri.getIva(),autocarri.getMax_capacity());
